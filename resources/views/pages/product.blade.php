...
<div class="detail-slider">
	<div class="slider-item">
		<img src="{{asset('assets/images')}}/{{$chitietsanpham->image1}}" alt="">
	</div>
	<div class="slider-item">
		<img src="{{asset('assets/images')}}/{{$chitietsanpham->image2}}" alt="">
	</div>
	<div class="slider-item">
		<img src="{{asset('assets/images')}}/{{$chitietsanpham->image3}}" alt="">
	</div>
	<div class="slider-item">
		<img src="{{asset('assets/images')}}/{{$chitietsanpham->image4}}" alt="">
	</div>
	<div class="slider-item">
		<img src="{{asset('assets/images')}}/{{$chitietsanpham->image5}}" alt="">
	</div>
</div>
